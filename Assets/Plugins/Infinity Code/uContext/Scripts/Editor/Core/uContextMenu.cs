...
namespace InfinityCode.uContext
{
    ...
    {
        public const string version = "2.8.1.1";
        ...
        [Obsolete("This property is obsoleted and will be removed soon.")]
        ...
        private static void CloseAllFloatingWindows()
        {
            try
            {
                ...
                foreach (PopupWindow wnd in windows)
                {
        ...
        {
#if UNITY_2020_1_OR_NEWER && !UNITY_2021_1_OR_NEWER || UNITY_2021_2_OR_NEWER
