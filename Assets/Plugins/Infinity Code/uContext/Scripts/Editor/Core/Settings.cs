...
namespace InfinityCode.uContext
{
    public static class Settings
    {
        ...
        private const string CREATE_BROWSER_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Create Browser";
        private const string FAVORITE_WINDOWS_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Favorite Windows";
        private const string GAMEOBJECT_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/GameObject";
        private const string HIERARCHY_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Hierarchy";
        private const string HIGHLIGHT_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Scene View/Highlight";
        private const string INSPECTOR_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Inspector";
        private const string NAVIGATION_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Scene View/Navigation";
        private const string QUICK_ACCESS_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Scene View/Quick Access Bar";
        private const string SCENEVIEW_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Scene View";
        private const string SEARCH_WINDOWS_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Search";
        private const string TOOLBAR_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Toolbar";
        private const string VIEWS_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Views";
        private const string WAILA_SETTINGS_PATH = UCONTEXT_SETTINGS_PATH + "/Scene View/WAILA";
